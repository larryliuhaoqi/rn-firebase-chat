...
class CardComponent extends Component {
    ...
    render() {
        ...
        const images = {
            ...
            "1": require('../../assets/image/feed_images/1.jpg'),
            "2": require('../../assets/image/feed_images/2.jpg'),
            "3": require('../../assets/image/feed_images/3.png'),
        }
        ...
        return (
            <Card>
                <CardItem>
                    <Left>
                        <Thumbnail source={require('../../assets/image/feed_images/3.png')} />
                        <Body>
                            <Text>Varun </Text>
